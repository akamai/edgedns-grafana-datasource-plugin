...
function (_super) {
  ...
  function ConfigEditor() {
    ...
    _this.onHostChange = function (event) {
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
    ...
    _this.onAccessTokenChange = function (event) {
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
    ...
    _this.onClientTokenChange = function (event) {
      var _a = _this.props,
          onOptionsChange = _a.onOptionsChange,
          options = _a.options;
...
function (_super) {
  ...
  function QueryEditor() {
    ...
    _this.getReports = function () {
      var uri = 'datasource/resource/openapireports';
      return _this.props.datasource.getResource(uri);
    };

    _this.onSelectReportsChange = function (item) {
      var _a = _this.props,
      ...
      console.log('selectedReport: ', item); // executes the query

      onRunQuery();
    };

    _this.onZoneNamesChange = function (event) {
      var _a = _this.props,
          onChange = _a.onChange,
          query = _a.query,
          onRunQuery = _a.onRunQuery;
      onChange(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), {
        zoneNames: event.target.value
      }));
      console.log('zoneNames: ' + event.target.value); // executes the query
    ...
    _this.onMetricNameChange = function (event) {
      ...
      console.log('metricName: ' + event.target.value); // executes the query
  ...
  QueryEditor.prototype.render = function () {
    ...
    var selectedReport = query.selectedReport,
        zoneNames = query.zoneNames,
        metricName = query.metricName;
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: "gf-form"
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["InlineField"], {
      label: "Report"
    }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["AsyncSelect"], {
