...
- Upgraded Grafana Plugin SDK (Go backend) from v0.286.0 to v0.293.0
- Upgraded Yarn from 1.22.22 to 4.17.1 (Yarn Modern)
- Upgraded frontend build and test tooling to latest (Jest 30, ESLint 9, webpack 5.108, Prettier 3.9, SWC)
